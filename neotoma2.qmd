...
We have searched Neotoma for sites by name and by location, inspected what datasets those
sites hold, filtered down to the records we wanted, pulled the sample data into R, and
harmonised a set of pollen morphotypes into a single taxon. Later chapters build on the objects
produced here.

Along the way there were four exercises. If you skipped any, they are worth returning to before
moving on, because the later chapters assume you are comfortable with searching and filtering:
